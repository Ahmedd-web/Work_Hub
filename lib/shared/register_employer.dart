      ...
      child: ListView(
        ...
        children: [
          ...
          CustomInputField(
            ...
            hint: s.registerEmployerNameHint,
            controller: companyNameController,
            validator: (val) {
              if (val == null || val.trim().isEmpty) return s.fieldRequired;
              return null;
            },
          ),
          ...
          CustomInputField(
            ...
            validator: (val) {
              if (val == null || val.trim().isEmpty) return s.fieldRequired;
              if (val.length < 6) return s.registerPasswordTooShort;
              return null;
            },
          ),
          const SizedBox(height: 30),
